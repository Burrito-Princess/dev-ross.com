        ...
        <div id="below-img" style="height: 60rem" class="overflow-hidden w-auto grow bg-king_pink flex flex-col items-center">
          ...
          <div class="bg-king_blue shadow-xl w-4/5 h-64 mt-20 rounded-2xl flex flex-col">
            <div class="mx-5 text-king_white">
              <div class="text-2xl mt-3">Other</div>
              <br>
              <div class="flex flex-col justify-center h-full w-full">
                ...
                <div class="h-full w-full flex justify-center">
                  ...
                  <a class="hover:bg-hover_king_pink shadow-xl h-2/3 w-1/2 text-black bg-king_pink m-3 flex justify-center items-center rounded-xl text-xl" href="https://spacehey.com/burrross" target="_blank">Spacehey</a>
                </div>
      ...
      <div id="content" class="md:mt-10 mt-0 font-lato">
        <div class="md:flex inline justify-center">
          <div class="md:w-1/2 w-full bg-king_blue text-king_white p-6 md:mx-3 mx-0 md:my-0 my-3 rounded-xl">
            ...
            <div>
              My passion is using databases and API's to make the website more dynamic. Getting information and using it in exciting ways is what I love to do.
              Front-end is something I wouldn't like to specialize in, but it would be a good skill to have. Therefore, am I open to learning more about it.
            </div>
          </div>
          <div class="md:w-1/2 w-full bg-king_blue text-king_white p-6 md:mx-3 mx-0 md:my-0 my-3 rounded-xl">
            ...
            <div>
              ...
              with friends I also prefer English over Dutch. Even though I'm fluent in both languages, I feel I
              can express myself better in English.
            </div>
          </div>
          ...
          <div class="md:flex inline justify-center">
            <div class="md:w-1/2 w-full bg-king_blue text-king_white p-6 md:mx-3 mx-0 md:my-0 my-3 rounded-xl">
              ...
              <div>
                ...
                <br><br>
                When I design my own models it's not something overly complicated, just functional. For example a stand for a
                server monitor, or a fan.
                I'm currently creating <a href="http://maaslanden.dev-ross.com"><span class="underline">my own board game</span></a> with 3D-printed models. Right now I'm in the process of writing the rules and the back-end.
              </div>
            </div>
            <div class="md:w-1/2 w-full bg-king_blue text-king_white p-6 md:mx-3 mx-0 md:my-0 my-3 rounded-xl">
